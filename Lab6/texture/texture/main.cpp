...
void DrawCubeMulti()
{
    ...
    // 绘制前面，这里开始确定纹理坐标，然后是确定点的位置
    glMultiTexCoord2i(GL_TEXTURE0, 0, 0); glMultiTexCoord2i(GL_TEXTURE1, 0, 0); glVertex3f(-0.5f, -0.5f,  0.5f);
    glMultiTexCoord2i(GL_TEXTURE0, 1, 0); glMultiTexCoord2i(GL_TEXTURE1, 1, 0); glVertex3f( 0.5f, -0.5f,  0.5f);
    glMultiTexCoord2i(GL_TEXTURE0, 1, 1); glMultiTexCoord2i(GL_TEXTURE1, 1, 1); glVertex3f( 0.5f,  0.5f,  0.5f);
    glMultiTexCoord2i(GL_TEXTURE0, 0, 1); glMultiTexCoord2i(GL_TEXTURE1, 0, 1); glVertex3f(-0.5f,  0.5f,  0.5f);
